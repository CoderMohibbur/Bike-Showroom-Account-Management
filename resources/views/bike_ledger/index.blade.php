...
<x-app-layout>
    <h1 class="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Bike Ledger</h1>

    <a href="{{ route('bike_ledger.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded mb-4 inline-block dark:bg-blue-600 dark:hover:bg-blue-500">Add New Entry</a>
